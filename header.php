...
<?php if(!wp_is_mobile()) : ?>
	<?php echo "<script type='text/javascript' src='".get_template_directory_uri().'/js/jquery.min.js'."'></script>"; ?>
	<?php echo "<script type='text/javascript' src='".get_template_directory_uri().'/js/masonry.pkgd.min.js'."'></script>"; ?>
<?php endif; ?>
<?php wp_head(); ?>
</head>
...
$ROOT = "/deeandbeat/"; ?>
	...
	<header id="masthead" class="site-header" role="banner">
		<div class="site-branding">
			...
			<?php if($URI != $ROOT) : ?>
			<h1 class="site-logo"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img alt="<?php bloginfo( 'name' ); ?>" src="http://comunikrte.es/deeandbeat/wp-content/uploads/2014/05/logo-2.jpg" /></a></h1>
			<?php else : ?>
			<h1 class="site-logo-main"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img alt="<?php bloginfo( 'name' ); ?>" src="<?php echo esc_url( get_theme_mod( 'graphy_logo' ) ); ?>" /></a></h1>
			<?php endif; ?>
